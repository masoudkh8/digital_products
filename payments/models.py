...
class Payment(models.Model):
    STATUS_VOID = 0         # نامشخص پرداخت
    STATUS_PAID = 10        # پرداخت اوکی بود
    STATUS_ERROR = 20       # پرداخت با ارور رو به رو شده
    STATUS_CANCELED = 30    # یوزر پرداخت را کنسل کرده
    STATUS_REFUNDED = 31    # یوزرا میگن پول ما رو پس بده
    STATUS_CHOICES = (
        (STATUS_VOID, _('Void')),
        (STATUS_PAID, _('Paid')),               # این قسمت پیغامهایی که قراره به یوزر نشون داده بشه
